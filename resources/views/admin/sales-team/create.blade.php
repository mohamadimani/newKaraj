                    ...
                    <form action="{{ route('sales-team.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" required placeholder="نام تیم را وارد کنید">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select select2" id="sales_team_manager_id" name="sales_team_manager_id" required data-placeholder="لطفا مدیر تیم را انتخاب کنید">
                                    ...
                                    <option value="{{ $secretary->id }}" {{ old('sales_team_manager_id')==$secretary->id ? 'selected' : '' }}>{{ $secretary->user->full_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="monthly_sale_target" name="monthly_sale_target" value="{{ old('monthly_sale_target', 0) }}" min="0"
                                    placeholder="مقدار تارگت فروش را وارد کنید">
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select select2" id="secretaries" name="secretaries[]" multiple data-placeholder="مشاورین  را انتخاب کنید">
                                    @foreach($secretaries as $secretary)
                                    <option value="{{ $secretary->id }}" {{ in_array($secretary->id, old('secretaries', [])) ? 'selected' : '' }}>{{ $secretary->user->full_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="description" name="description" value="{{ old('description') }}" placeholder="توضیحات را وارد کنید">
                            </div>
                        </div>
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>ایجاد تیم فروش
                            </button>
                        </div>
                    </form>
                </div>
