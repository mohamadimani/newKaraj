            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (isset($order) and isset($order->id))
                        ...
                        @endif
                        <a class="btn btn-primary w-100 my-3" href="{{ route('user.orders.show', [$order->id]) }}">بازگشت</a>
                    @else
