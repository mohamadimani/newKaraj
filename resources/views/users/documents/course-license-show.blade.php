...
<div id="printable" class="container1">
    ...
    <div class="center">
        ...
        <p class="course mt-4-5 f1-5">{{$courseRegister->course->profession->title}}</p>
        <p class="time mt-4-5 f1-5">{{$courseRegister->course->duration_hours}}</p>
        <p class="start mt-4-5 f1-5">{{georgianToJalali($courseRegister->course->start_date)}}</p>
        <p class="end mt-4-5 f1-5">{{georgianToJalali($courseRegister->course->end_date)}}</p>
    </div>
    <div class="center2">
