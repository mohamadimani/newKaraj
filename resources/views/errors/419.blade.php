...
<body>
    ...
    <div class="container-404 text-center text-light">
        <div class="number404">419</div>
        <div class="error-text">مرورگر شما کش کرده</div>
        <div class="error-text">یا کش مرورگرت رو پاک کن یا مرورگرت رو عوض کن</div>
