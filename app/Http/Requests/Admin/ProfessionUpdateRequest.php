...
class ProfessionUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'title' => 'required|string|max:255|unique:professions,title,' . $this->profession . ',id,deleted_at,NULL',
            ...
            'private_duration_hours' => 'nullable|numeric|min:0',
            'private_capacity' => 'nullable|numeric|min:0',
